    ...
    for(Point currentPoint1 : Pcoords1)
    {
        for(Point currentPoint2 : Pcoords2)
        {
            if(doIntersect(previousPoint1, currentPoint1, previousPoint2, currentPoint2))
            {
                ...
                {
                    int last_point_to_intersection_point_distance_1 = abs(intersectingPoints.back().x - previousPoint1.x) + abs(intersectingPoints.back().y - previousPoint1.y);
                    int last_point_to_intersection_point_distance_2 = abs(intersectingPoints.back().x - previousPoint2.x) + abs(intersectingPoints.back().y - previousPoint2.y);

                    int total_distance_1 = last_point_to_intersection_point_distance_1 + previousPoint1.distance;
                    int total_distance_2 = last_point_to_intersection_point_distance_2 + previousPoint2.distance;
